...
import Checkbox from '@material-ui/core/Checkbox';
 ...
 class Step3 extends Component {
  ...
  let currentProject =  [this.state.redesign,this.state.plan,this.state.launch,this.state.rebrand]
   ...
   axios.post('http://localhost:3001/api/teamlead',details)
  }
  ...
  handlerebrandChange = () => event => {
    ...
    <div>
       ...
       <FormControl component="fieldset">
        <FormLabel component="legend">Do you have any of these projects going on right now?</FormLabel>
        ...
        <FormGroup>
          ...
          <button onClick={this.submit}>All done!</button>
             ...
             <div>
             <Link to="/setup/step2"> <button>Previous Step</button></Link>
             </div>                 
    </div>
  )
}
